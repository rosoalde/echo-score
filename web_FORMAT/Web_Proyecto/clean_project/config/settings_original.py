...
start_date = "2025-04-01"#"2025-12-30"#"2026-01-06"#
end_date   = "2025-09-30"#"2025-12-31"#"2026-01-09"#
...
general = {
    ...
    "output_folder": f"DRONES_INFORME{start_date.replace('-', '')}_{end_date.replace('-', '')}"
}
# ==============================
